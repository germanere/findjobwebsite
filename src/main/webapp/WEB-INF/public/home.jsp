            ...
            <div class="col-md-3 " >
                ...
                width:1000px; letter-spacing: 1px; display:flex">
				   <c:forEach var="cate" items="${category}">
                    <li><a style="width:100px;text-decoration: none !important;" href="${'/recruitment/category/'}${categorie.id}"> 
                    <p>${cate.name}</p>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 sidebar">
                ...
                <div class="sidebar-box">
                    <div class="">
                        <a th:href="${'/user/detail-company/'}+${companies[0]}" class="company-wrap"><img src="${companies[2]}" class="img-fluid" alt="Colorlib Free Template"></a>
                        <div class="text p-3">
