...
<section class="ftco-section bg-light" th:if="${session.user}">
    <div class="container">
        <h4 style="margin-top: -20px">Kết quả tìm kiếm cho : <span>${keySearchadr}></span></h4>
        <div class="row">
            <div class="col-lg-12 pr-lg-5">
                            ...
                            <div class="job-post-item p-4 d-block d-lg-flex align-items-center">
                                <div class="one-third mb-4 mb-md-0">
                                    <div class="job-post-item-header align-items-center">
                                        ...
                                        <h2 class="mr-3 text-black" ><a href="${'/recruitment/'}${rec.id}">${rec.tittle}</a></h2>
                                    </div>
                                ...
                                <div class="one-forth ml-auto d-flex align-items-center mt-4 md-md-0">
                                    ...
                                    <a data-bs-toggle="modal" data-bs-target="${'#exampleModal'}${rec.id}" class="btn btn-primary py-2" th:if="${session.user.role.id == 1 }">Apply Job</a>
                                </div>
                            </div>
                        </div><!-- end -->
                        <!-- Modal -->
                                    ...
                                    <form method="post" action="/user/apply-job">
                                        <div class="modal-body">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <button type="button" id="${'button1'}${rec.id}" style="display: none" onclick="'apply1(' +${rec.id}+ ')'" class="btn btn-primary">Nộp</button>
                ...
                <div class="row mt-5">
                    <div class="col text-center">
                        <div class="block-27">
                            <ul>
                                <li th:if="${numberPage>0}"><a href="@{'/recruitment/search/'+ ${keySearch}(page = ${list.number - 1})}">&lt;</a></li>
                                <th:block th:each="recruitment,state  : ${recruitmentList}">
                                    <li th:class="${numberPage == state.index  ? 'active' : null }"><a href="@{'/recruitment/search/'+ ${keySearch}(page = ${state.index})}" th:text="${state.index + 1}"></a></li>
                                </th:block>
                                <li th:if="${numberPage<list.totalPages - 1}"><a href="@{'/recruitment/search/'+ ${keySearch}(page = ${list.number + 1})}">&gt;</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
